...
namespace dp2.KernelService
{
    ...
    public class RmsChannelCollection : Hashtable, IDisposable
    {
        ...
        KernelApplication _app = null;

        public RmsChannelCollection(KernelApplication app)
        {
            _app = app;
        }
    ...
    // 一个通讯通道
    public class RmsChannel : dp2Kernel.KernelService
    {
        /// <summary>
        /// RecieveTimeout
        /// </summary>
 ...
 * */
        ...
        REDO:
            ...
            try
            {
                result = this.Login(strUserName, strPassword);
            }
            catch (Exception ex)
            {
        ...
        REDO:
            try
            {
                Result result = Login(strUserName, strPassword);
        ...
        REDO:
            try
            {
                ...
                if (bManager == false)
                {
                    result = this.ChangePassword(strNewPassword);
                }
                else
                {
                    result = this.ChangeOtherPassword(strUserName, strNewPassword);
                }
        ...
        REDO:
            ...
            {
            REDOINITIAL:
                Result result = this.InitializeDb(strDBName);
        ...
        REDO:
            ...
            {
            REDO_REFRESH:
                Result result = this.RefreshDb(strAction,
                    strDBName,
                    bClearAllKeyTables);
        ...
        REDO:
            ...
            {
            REDOINITIAL:
                Result result = this.DeleteDb(strDBName);
        ...
        REDO:
            ...
            {
            REDOCREATE:
                Result result = this.CreateDb(logicnames,
                    strType,
                    strSqlDbName,
                    strKeysDef,
                    strBrowseDef);
        ...
        REDO:
            ...
            {
            REDOCREATE:
                Result result = this.SetDbInfo(strOldDbName,
                    logicnames,
                    strType,
                    strSqlDbName,
                    strKeysDef,
    ...
    out string strError)
        ...
        REDO:
            ...
            {
            REDOSEARCH:
                Result result = this.Search(strQueryXml,
                    strResultSetName,
                    strOutputStyle);
            ...
            out string strError)
        {
            ...
            for (; ; )
            {
                ...
                try
                {
                    ...
                    Result result = this.GetRichRecords(
                        strResultSetName,
                        strRange,
                        strLang,
                        strStyle,
        ...
        REDO:
            try
            {
                Result result = this.WriteRecords(
                    inputs,
                    strStyle,
                    out results);
        ...
        REDO:
            try
            {
                Result result = this.RebuildResKeys(
                    strPath,
                    strStyle,
                    out strOutputResPath);
