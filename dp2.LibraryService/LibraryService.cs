...
namespace dp2.LibraryService
{
    ...
    HttpContext context)
        ...
        public static LibraryApplication NewApplication(string strDataDir,
            KernelApplication kernel_app)
        {
            string strError = "";
        ...
        START:
            var app = new LibraryApplication();
            app.KernelApplication = kernel_app;

            /*
            app.TestMode = info.TestMode;
            app.MaxClients = info.MaxClients;
            app.LicenseType = info.LicenseType;
            app.Function = info.Function;
            */
